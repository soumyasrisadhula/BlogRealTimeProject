...
#send_mail('Hello', 'Message from Pycharm....','soumyasrisadhula@gmail.com',['s.soumya45321@gmail.com','soumyasri5195@gmail.com'])
...
def mail_send_view(request,id):
    ...
    if request.method=='POST':
        ...
        if form.is_valid():
            ...
            send_mail(subject, message, 'soumyasrisadhula@gmail.com', [cd['to']]) #use[] or ()tuple
            sent=True;
    else:
        form=EmailSendForm()
